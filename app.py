...
def health_report_get_lab_status(
    ...
    if (
        ...
        lower, upper = (
            health_report_parse_reference_range(
                reference_range
            )
        )
